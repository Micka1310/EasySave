    ...
    {
        {
            Lang.FR, new Dictionary<string, string>
            {
                ...
                { "log_format_select_title", "Format des journaux (fichier par jour)" },
                { "log_format_option_json", "JSON (.json)" },
                { "log_format_option_xml", "XML (.xml)" },
                { "log_format_choice", "Choisissez le format des journaux :\n1. JSON\n2. XML" },
                { "log_format_changed_json", "Format des journaux défini sur JSON." },
                { "log_format_changed_xml", "Format des journaux défini sur XML." },
        ...
        },
        {
            Lang.EN, new Dictionary<string, string>
            {
                ...
                { "log_format_select_title", "Log file format (one file per day)" },
                { "log_format_option_json", "JSON (.json)" },
                { "log_format_option_xml", "XML (.xml)" },
                { "log_format_choice", "Choose log file format:\n1. JSON\n2. XML" },
